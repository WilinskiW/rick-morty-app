...
create table characters (id integer not null auto_increment, location_id integer, origin_id integer, created datetime(6), gender varchar(255), image varchar(255), name varchar(255), species varchar(255), status varchar(255), type varchar(255), primary key (id)) engine=InnoDB;
create table episodes (id integer not null auto_increment, created datetime(6), air_date varchar(255), episode varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table locations (id integer not null auto_increment, created datetime(6), dimension varchar(255), name varchar(255), type varchar(255), primary key (id)) engine=InnoDB;
